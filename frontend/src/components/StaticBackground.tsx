  ...
  return (
    <>
      ...
      <svg className="absolute inset-0 w-full h-full opacity-20" preserveAspectRatio="none" viewBox="0 0 1440 800">
        <path fill="url(#bg-wave1)" d="M0,320 C320,380 420,280 720,320 C1020,360 1120,280 1440,320 L1440,800 L0,800 Z" opacity="0.7">
        ...
        <path fill="url(#bg-wave2)" d="M0,400 C360,450 540,350 900,400 C1260,450 1440,350 1440,400 L1440,800 L0,800 Z" opacity="0.5">
        ...
        <path fill="url(#bg-wave3)" d="M0,480 C400,520 640,450 1000,480 C1360,510 1440,460 1440,480 L1440,800 L0,800 Z" opacity="0.4">
        ...
        <defs>
          <linearGradient id="bg-wave1" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="#a855f7" stopOpacity="0.8"/>
            <stop offset="100%" stopColor="#ec4899" stopOpacity="0.6"/>
          </linearGradient>
          <linearGradient id="bg-wave2" x1="0%" y1="0%" x2="100%" y2="0%">
            <stop offset="0%" stopColor="#3b82f6" stopOpacity="0.7"/>
            <stop offset="100%" stopColor="#8b5cf6" stopOpacity="0.5"/>
          </linearGradient>
          <linearGradient id="bg-wave3" x1="100%" y1="0%" x2="0%" y2="100%">
