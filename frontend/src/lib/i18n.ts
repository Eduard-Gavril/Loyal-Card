  ...
  en: {
    ...
    admin: {
      ...
      products: {
        ...
        rulesDesc: 'Here you can configure advanced rules for this product. Feature in development.',
        close: 'Close',
      },
    },
  ...
  ro: {
    ...
    admin: {
      ...
      products: {
        ...
        rulesDesc: 'Aici poți configura reguli avansate pentru acest produs. Funcționalitate în dezvoltare.',
        close: 'Închide',
      },
    },
