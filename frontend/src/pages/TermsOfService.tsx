      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        <div className="bg-white rounded-xl shadow-sm p-6 sm:p-8">
          <div className="prose prose-blue max-w-none text-gray-900">
            ...
            <p>
              We are LoyalCard ('Company', 'we', 'us', or 'our'), a company registered in Romania at aleea petru rares, 
              targu frumos, iasi romania 705300.
            </p>

            <p>
              We operate the website <a href="https://loyalcard.net" className="text-primary-600 hover:text-primary-700">https://loyalcard.net</a> (the 'Site'), 
              as well as any other related products and services that refer or link to these legal terms (the 'Legal Terms') 
              (collectively, the 'Services').
            </p>

            <p>
              You can contact us by phone at 0750438655, email at{' '}
              ...
              or by mail to aleea petru rares, targu frumos, iasi romania 705300, Romania.
            </p>

            <p>
              These Legal Terms constitute a legally binding agreement made between you, whether personally or on behalf of 
              an entity ('you'), and LoyalCard, concerning your access to and use of the Services. You agree that by accessing 
              the Services, you have read, understood, and agreed to be bound by all of these Legal Terms. <strong>IF YOU DO 
              NOT AGREE WITH ALL OF THESE LEGAL TERMS, THEN YOU ARE EXPRESSLY PROHIBITED FROM USING THE SERVICES AND YOU 
              MUST DISCONTINUE USE IMMEDIATELY.</strong>
            </p>
            ...
            <ol className="list-decimal list-inside space-y-2">
              <li><a href="#section1" className="text-primary-600 hover:text-primary-700">OUR SERVICES</a></li>
              <li><a href="#section2" className="text-primary-600 hover:text-primary-700">INTELLECTUAL PROPERTY RIGHTS</a></li>
              <li><a href="#section3" className="text-primary-600 hover:text-primary-700">USER REPRESENTATIONS</a></li>
              <li><a href="#section4" className="text-primary-600 hover:text-primary-700">USER REGISTRATION</a></li>
              <li><a href="#section5" className="text-primary-600 hover:text-primary-700">PURCHASES AND PAYMENT</a></li>
              <li><a href="#section6" className="text-primary-600 hover:text-primary-700">SUBSCRIPTIONS</a></li>
              <li><a href="#section7" className="text-primary-600 hover:text-primary-700">PROHIBITED ACTIVITIES</a></li>
              <li><a href="#section8" className="text-primary-600 hover:text-primary-700">USER GENERATED CONTRIBUTIONS</a></li>
              <li><a href="#section9" className="text-primary-600 hover:text-primary-700">CONTRIBUTION LICENCE</a></li>
              <li><a href="#section10" className="text-primary-600 hover:text-primary-700">SERVICES MANAGEMENT</a></li>
              <li><a href="#section11" className="text-primary-600 hover:text-primary-700">PRIVACY POLICY</a></li>
              <li><a href="#section12" className="text-primary-600 hover:text-primary-700">TERM AND TERMINATION</a></li>
              <li><a href="#section13" className="text-primary-600 hover:text-primary-700">MODIFICATIONS AND INTERRUPTIONS</a></li>
              <li><a href="#section14" className="text-primary-600 hover:text-primary-700">GOVERNING LAW</a></li>
              <li><a href="#section15" className="text-primary-600 hover:text-primary-700">DISPUTE RESOLUTION</a></li>
              <li><a href="#section16" className="text-primary-600 hover:text-primary-700">CORRECTIONS</a></li>
              <li><a href="#section17" className="text-primary-600 hover:text-primary-700">DISCLAIMER</a></li>
              <li><a href="#section18" className="text-primary-600 hover:text-primary-700">LIMITATIONS OF LIABILITY</a></li>
              <li><a href="#section19" className="text-primary-600 hover:text-primary-700">INDEMNIFICATION</a></li>
              <li><a href="#section20" className="text-primary-600 hover:text-primary-700">USER DATA</a></li>
              <li><a href="#section21" className="text-primary-600 hover:text-primary-700">ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</a></li>
              <li><a href="#section22" className="text-primary-600 hover:text-primary-700">MISCELLANEOUS</a></li>
              <li><a href="#section23" className="text-primary-600 hover:text-primary-700">CONTACT US</a></li>
            </ol>

            <h2 id="section1" className="text-2xl font-bold mt-8 mb-4">1. OUR SERVICES</h2>
            ...
            <h2 id="section2" className="text-2xl font-bold mt-8 mb-4">2. INTELLECTUAL PROPERTY RIGHTS</h2>
            ...
            <p>
              ...
              <a href="mailto:eduardgavril.1999@gmail.com" className="text-primary-600 hover:text-primary-700">eduardgavril.1999@gmail.com</a>. 
              If we ever grant you the permission to post, reproduce, or publicly display any part of our Services or Content, you 
            ...
            <ul>
              ...
              <li>
                warrant that any such Submission are original to you or that you have the necessary rights and licences to submit 
            ...
            <h2 id="section3" className="text-2xl font-bold mt-8 mb-4">3. USER REPRESENTATIONS</h2>
            ...
            <h2 id="section4" className="text-2xl font-bold mt-8 mb-4">4. USER REGISTRATION</h2>
            ...
            <h2 id="section5" className="text-2xl font-bold mt-8 mb-4">5. PURCHASES AND PAYMENT</h2>
            ...
            <p>
              ...
              you authorise us to charge your chosen payment provider for any such amounts upon placing your order. We reserve the 
            ...
            <h2 id="section6" className="text-2xl font-bold mt-8 mb-4">6. SUBSCRIPTIONS</h2>
            ...
            <h2 id="section7" className="text-2xl font-bold mt-8 mb-4">7. PROHIBITED ACTIVITIES</h2>
            ...
            <h2 id="section8" className="text-2xl font-bold mt-8 mb-4">8. USER GENERATED CONTRIBUTIONS</h2>
            ...
            <p>
              ...
              personal information or other material (collectively, 'Contributions'). Contributions may be viewable by other users 
              of the Services and through third-party websites. As such, any Contributions you transmit may be treated in accordance 
              with the Services' Privacy Policy. When you create or make available any Contributions, you thereby represent and 
              warrant that:
            </p>
            ...
            <h2 id="section9" className="text-2xl font-bold mt-8 mb-4">9. CONTRIBUTION LICENCE</h2>
            ...
            <h2 id="section10" className="text-2xl font-bold mt-8 mb-4">10. SERVICES MANAGEMENT</h2>
            ...
            <ol className="list-decimal list-inside space-y-2">
              ...
              <li>
                in our sole discretion and without limitation, notice, or liability, to remove from the Services or otherwise disable 
                all files and content that are excessive in size or are in any way burdensome to our systems; and
              </li>
              <li>
                otherwise manage the Services in a manner designed to protect our rights and property and to facilitate the proper 
                functioning of the Services.
              </li>
            </ol>

            <h2 id="section11" className="text-2xl font-bold mt-8 mb-4">11. PRIVACY POLICY</h2>

            <p>
              We care about data privacy and security. Please review our Privacy Policy:{' '}
              <a href="https://loyalcard.net/privacy" className="text-primary-600 hover:text-primary-700">https://loyalcard.net/privacy</a>. 
              By using the Services, you agree to be bound by our Privacy Policy, which is incorporated into these Legal Terms. 
              Please be advised the Services are hosted in Romania. If you access the Services from any other region of the world 
              with laws or other requirements governing personal data collection, use, or disclosure that differ from applicable laws 
              in Romania, then through your continued use of the Services, you are transferring your data to Romania, and you 
              expressly consent to have your data transferred to and processed in Romania.
            </p>

            <h2 id="section12" className="text-2xl font-bold mt-8 mb-4">12. TERM AND TERMINATION</h2>

            <p>
              These Legal Terms shall remain in full force and effect while you use the Services. <strong>WITHOUT LIMITING ANY OTHER 
              ...
              TERMS OR OF ANY APPLICABLE LAW OR REGULATION. WE MAY TERMINATE YOUR USE OR PARTICIPATION IN THE SERVICES OR DELETE YOUR 
              ACCOUNT AND ANY CONTENT OR INFORMATION THAT YOU POSTED AT ANY TIME, WITHOUT WARNING, IN OUR SOLE DISCRETION.</strong>
            </p>
            ...
            <h2 id="section13" className="text-2xl font-bold mt-8 mb-4">13. MODIFICATIONS AND INTERRUPTIONS</h2>

            <p>
              We reserve the right to change, modify, or remove the contents of the Services at any time or for any reason at our 
              sole discretion without notice. However, we have no obligation to update any information on our Services. We will not 
            ...
            <h2 id="section14" className="text-2xl font-bold mt-8 mb-4">14. GOVERNING LAW</h2>

            <p>
              These Legal Terms are governed by and interpreted following the laws of Romania, and the use of the United Nations 
              Convention of Contracts for the International Sales of Goods is expressly excluded. If your habitual residence is in 
              the EU, and you are a consumer, you additionally possess the protection provided to you by obligatory provisions of the 
              law in your country to residence. LoyalCard and yourself both agree to submit to the non-exclusive jurisdiction of the 
              courts of iasi, which means that you may make a claim to defend your consumer protection rights in regards to these 
              Legal Terms in Romania, or in the EU country in which you reside.
            </p>

            <h2 id="section15" className="text-2xl font-bold mt-8 mb-4">15. DISPUTE RESOLUTION</h2>
            ...
            <p>
              ...
              informally for at least sixty (60) days before initiating arbitration. Such informal negotiations commence upon written 
            ...
            <p>
              ...
              who will be chosen in accordance with the Arbitration and Internal Rules of the European Court of Arbitration being part 
              of the European Centre of Arbitration having its seat in Strasbourg, and which are in force at the time the application 
              for arbitration is filed, and of which adoption of this clause constitutes acceptance. The seat of arbitration shall be 
              targu frumos, Romania. The language of the proceedings shall be italian. Applicable rules of substantive law shall be 
              the law of Romania.
            </p>
            ...
            <ul>
              ...
              <li>(b) there is no right or authority for any Dispute to be arbitrated on a class-action basis or to utilise class action procedures; and</li>
            ...
            <p>The Parties agree that the following Disputes are not subject to the above provisions concerning informal negotiations binding arbitration:</p>
            ...
            <ul>
              ...
              <li>(b) any Dispute related to, or arising from, allegations of theft, piracy, invasion of privacy, or unauthorised use; and</li>
              <li>(c) any claim for injunctive relief.</li>
            </ul>
            ...
            <h2 id="section16" className="text-2xl font-bold mt-8 mb-4">16. CORRECTIONS</h2>
            ...
            <h2 id="section17" className="text-2xl font-bold mt-8 mb-4">17. DISCLAIMER</h2>
            ...
            <h2 id="section18" className="text-2xl font-bold mt-8 mb-4">18. LIMITATIONS OF LIABILITY</h2>
            ...
            <p className="uppercase">
              ...
              THE TWELVE (12) MONTH PERIOD PRIOR TO ANY CAUSE OF ACTION ARISING OR €500. CERTAIN US STATE LAWS AND INTERNATIONAL LAWS 
              DO NOT ALLOW LIMITATIONS ON IMPLIED WARRANTIES OR THE EXCLUSION OR LIMITATION OF CERTAIN DAMAGES. IF THESE LAWS APPLY TO 
              YOU, SOME OR ALL OF THE ABOVE DISCLAIMERS OR LIMITATIONS MAY NOT APPLY TO YOU, AND YOU MAY HAVE ADDITIONAL RIGHTS.
            </p>

            <h2 id="section19" className="text-2xl font-bold mt-8 mb-4">19. INDEMNIFICATION</h2>
            ...
            <p>
              ...
              your violation of the rights of a third party, including but not limited to intellectual property rights; or (5) any overt 
              harmful act toward any other user of the Services with whom you connected via the Services. Notwithstanding the foregoing, 
              we reserve the right, at your expense, to assume the exclusive defence and control of any matter for which you are 
              required to indemnify us, and you agree to cooperate, at your expense, with our defence of such claims. We will use 
            ...
            <h2 id="section20" className="text-2xl font-bold mt-8 mb-4">20. USER DATA</h2>
            ...
            <h2 id="section21" className="text-2xl font-bold mt-8 mb-4">21. ELECTRONIC COMMUNICATIONS, TRANSACTIONS, AND SIGNATURES</h2>
            ...
            <p>
              ...
              we provide to you electronically, via email and on the Services, satisfy any legal requirement that such communication be 
              in writing. <strong>YOU HEREBY AGREE TO THE USE OF ELECTRONIC SIGNATURES, CONTRACTS, ORDERS, AND OTHER RECORDS, AND TO 
              ELECTRONIC DELIVERY OF NOTICES, POLICIES, AND RECORDS OF TRANSACTIONS INITIATED OR COMPLETED BY US OR VIA THE SERVICES.</strong> 
            ...
            <h2 id="section22" className="text-2xl font-bold mt-8 mb-4">22. MISCELLANEOUS</h2>
            ...
            <p>
              ...
              provision of these Legal Terms shall not operate as a waiver of such right or provision. These Legal Terms operate to the 
              ...
              control. If any provision or part of a provision of these Legal Terms is determined to be unlawful, void, or unenforceable, 
              ...
              not be construed against us by virtue of having drafted them. You hereby waive any and all defences you may have based on 
              the electronic form of these Legal Terms and the lack of signing by the parties hereto to execute these Legal Terms.
            </p>

            <h2 id="section23" className="text-2xl font-bold mt-8 mb-4">23. CONTACT US</h2>
            ...
            <address className="not-italic">
              ...
              Romania<br />
              <strong>Phone:</strong> 0750438655<br />
              <strong>Email:</strong> <a href="mailto:eduardgavril.1999@gmail.com" className="text-primary-600 hover:text-primary-700">eduardgavril.1999@gmail.com</a>
            </address>
          </div>
        </div>
      </main>
